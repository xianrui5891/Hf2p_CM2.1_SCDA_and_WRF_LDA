...
use ada_types_mod,      only: scda_type !snz 20250426
...
!lulv 20200608 subroutine update_atmos_model_down( Surface_boundary, Atmos )
subroutine update_atmos_model_down( Surface_boundary, Atmos, atm_step,atm_end_flag, CBVar) !lulv add atm_step
!
!-----------------------------------------------------------------------
  ...
  type (scda_type), intent(inout) :: CBVar
...
!-----------------------------------------------------------------------
  call mpp_clock_begin(atmClock)
    ...
    call atmosphere_down (Atmos%Time, Surface_boundary%land_frac,        &
                          ...
                          Atmos%flux_lw,                &
                          Atmos%Surf_diff, atm_step,atm_end_flag, CBVar) !lulv add atm_step 20201111,20250426snz
