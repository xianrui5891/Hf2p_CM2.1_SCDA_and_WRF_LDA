...
character(len=256) :: version=&
     '$Id: ocean_vert_kpp.F90,v 1.1.2.2.2.20.6.2.16.1.16.2.20.1.18.4 2010/03/29 16:52:38 smg Exp $'
...
! </DESCRIPTION>
!
subroutine ocean_vert_kpp_init (Grid, Domain, Time, Time_steps, Dens, T_prog, T_diag, &
