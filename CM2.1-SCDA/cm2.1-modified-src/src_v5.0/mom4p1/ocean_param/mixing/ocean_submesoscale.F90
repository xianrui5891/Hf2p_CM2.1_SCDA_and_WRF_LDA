...
integer :: id_neutral_rho_submeso_on_nrho =-1
...
! </DESCRIPTION>
  ...
  id_neutral_rho_submeso_on_nrho = register_diag_field ('ocean_model',              &
     'neutral_rho_submeso_on_nrho', Dens%neutralrho_axes(1:3), Time%model_time,     &
     'update of neutral density from submeso as mapped to neutral density surfaces',&
     '(kg/m^3)/sec', missing_value=missing_value, range=(/-1.e10,1.e10/))
  ...
  id_wdian_rho_submeso_on_nrho = register_diag_field ('ocean_model',                       &
     ...
     'dianeutral velocity component due to submeso as mapped to neutral density surfaces', &
     'm/sec', missing_value=missing_value, range=(/-1.e10,1.e10/))
...
!
  ...
  ! diagnostics for neutral density evolution and dianeutral velocity component  
  ...
  if(nrho_diagnostics) then 
      if (id_neutral_rho_submeso_on_nrho > 0) then 
         wrk1(:,:,:)      = 0.0
         nrho_work(:,:,:) = 0.0
          do k=1,nk
             do j=jsc,jec
          ...
          used = send_data (id_neutral_rho_submeso_on_nrho, nrho_work(:,:,:),&
          Time%model_time,                                                   &
