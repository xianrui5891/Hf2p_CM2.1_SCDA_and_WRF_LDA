...
character(len=128) :: version=&
     '$Id: ocean_nphysicsB.F90,v 1.1.2.27.12.7.18.2.18.1.32.1.4.1.14.8 2010/03/29 16:52:37 smg Exp $'
...
subroutine ocean_nphysicsB_init(Grid, Domain, Time, Time_steps, Thickness, Dens, T_prog,&
  ...
  if(diagnose_gm_redi) then 
     write(stdoutunit,'(1x,a)') &
     ' ==>NOTE: ocean_nphysicB has diagnose_gm_redi=.true. to diagnose GM and Redi. It adds much to memory requirements.' 
