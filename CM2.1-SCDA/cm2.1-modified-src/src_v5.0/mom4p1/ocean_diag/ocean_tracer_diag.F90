...
character(len=128) :: version=&
     '$Id: ocean_tracer_diag.F90,v 1.1.2.2.2.34.28.4.44.1.32.1.4.2.10.1 2010/03/17 21:22:23 smg Exp $'
...
!
! Coded March 2010 by Stephen.Griffies@noaa.gov 
!
! </DESCRIPTION>
!
