...
!
  ...
  character(len=128) :: version = &
     '$Id: ocean_types.F90,v 16.0.2.8.6.1.2.3.6.1.18.1 2010/02/22 16:07:53 smg Exp $'
  ...
  type, public :: ocean_options_type
     ...
     character(len=72)  :: bmf_barotropic
...
!################################################################################################
  ...
  type, public :: ocean_velocity_type
     ...
     logical                                 :: bmf_barotropic ! is true when computing bmf using vertically averaged velocity
