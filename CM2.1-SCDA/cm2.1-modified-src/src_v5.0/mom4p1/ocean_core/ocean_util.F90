...
!#######################################################################
! <SUBROUTINE NAME="invtri_bmf_old">
!
! <DESCRIPTION>
! Solve the vertical diffusion equation implicitly using the
! method of inverting a tridiagonal matrix as described in
...
! </DESCRIPTION>
!
subroutine invtri_bmf_old (z, topbc, botbc, dcb, tdt, kmz, mask, dh, dhw, aidif, nk)
