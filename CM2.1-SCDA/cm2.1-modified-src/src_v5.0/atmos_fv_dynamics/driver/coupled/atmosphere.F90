...
use            fv_pack, only: nlon, mlat, nlev, beglat, endlat, beglon, &
                              ...
                              fv_end, change_time, restart_write_format, area, &
                              ak, bk
...
!  --- initialize clocks for dynamics, physics_down and physics_up
 ...
 subroutine atmosphere_down (Time,    frac_land,             &
      ...
      flux_sw_vis_dif,                &
      flux_lw,                        &
      Surf_diff, atm_step,atm_end_flag, CBVar) !lulv add atm_step 20201111,20250426snz
#include "fv_arrays.h"
!
...
!---- call physics -----
   ...
   call fv_physics_down (dt_atmos, Time_prev, Time, Time_next,     &
        ...
        flux_sw_vis_dif, flux_lw,       &
        coszen, gust, Surf_diff, atm_step,atm_end_flag, CBVar) !lulv add atm_step 20201111,20250426snz
