...
!-------------------------------------------------------------------
! Deallocate several pointers/arrays in Lw_tables
      IF ( ASSOCIATED(Lw_tables%bdlocm) ) DEALLOCATE(Lw_tables%bdlocm)
      IF ( ASSOCIATED(Lw_tables%bdhicm) ) DEALLOCATE(Lw_tables%bdhicm)
      IF ( ASSOCIATED(Lw_tables%iband) ) DEALLOCATE(Lw_tables%iband)
      IF ( ASSOCIATED(Lw_tables%bandlo) ) DEALLOCATE(Lw_tables%bandlo)
      IF ( ASSOCIATED(Lw_tables%bandhi) ) DEALLOCATE(Lw_tables%bandhi)
