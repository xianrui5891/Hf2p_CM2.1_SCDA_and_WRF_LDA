...
NETCDF_ROOT = /home/ouc/zhuxianrui/environment/cm2only
MPI_ROOT    = $(MPICH_DIR)
...
FFLAGS := -msse2 -fno-alias -auto -safe-cray-ptr -ftz -assume byterecl -i4 -r8 -nowarn -sox -traceback -fPIC $(INCLUDE)
...
CFLAGS := -D__IFC -msse2 -sox -traceback -fPIC $(INCLUDE)  #----lulv
...
ifneq ($(findstring netcdf-4.0.1,$(LOADEDMODULES)),)
  ...
  LIBS += -lnetcdff -lnetcdf -L/home/ouc/zhuxianrui/environment/cm2only/lib    #----lulv
endif
