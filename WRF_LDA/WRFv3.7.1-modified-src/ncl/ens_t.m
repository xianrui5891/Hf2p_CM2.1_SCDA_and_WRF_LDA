...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS5DAYT%d', i));
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS5DAYT%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS5DAYT%d', i), t_write ) ;
    i
end
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS1DAYT%d', i));
    T_1D = reshape(T, [dims_read(1) * dims_read(2) * dims_read(3), 1]);
    T_1D = double(T_1D);
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS1DAYT%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS1DAYT%d', i), t_write ) ;
    i
end
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS6HT%d', i));
    T_1D = reshape(T, [dims_read(1) * dims_read(2) * dims_read(3), 1]);
    T_1D = double(T_1D);
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS6HT%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS6HT%d', i), t_write ) ;
    i
end
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS3HT%d', i));
    T_1D = reshape(T, [dims_read(1) * dims_read(2) * dims_read(3), 1]);
    T_1D = double(T_1D);
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS3HT%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS3HT%d', i), t_write ) ;
    i
end
