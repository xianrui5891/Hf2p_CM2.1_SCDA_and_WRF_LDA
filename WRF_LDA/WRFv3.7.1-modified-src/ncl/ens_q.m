...
t_write   = ncread(outputFile, 'QVAPOR');
...
t_read    = ncread(inputFile, 'QVAPOR');
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS5DAYQ%d', i));
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS5DAYQ%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS5DAYQ%d', i), t_write ) ;
    i
end
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS1DAYQ%d', i));
    T_1D = reshape(T, [dims_read(1) * dims_read(2) * dims_read(3), 1]);
    T_1D = double(T_1D);
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS1DAYQ%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS1DAYQ%d', i), t_write ) ;
    i
end
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS6HQ%d', i));
    T_1D = reshape(T, [dims_read(1) * dims_read(2) * dims_read(3), 1]);
    T_1D = double(T_1D);
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS6HQ%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS6HQ%d', i), t_write ) ;
    i
end
...
parfor i = 1:20
    i
    T = ncread(inputFile, sprintf('ENS3HQ%d', i));
    T_1D = reshape(T, [dims_read(1) * dims_read(2) * dims_read(3), 1]);
    T_1D = double(T_1D);
...
ntime=size(1)
for i=1:20
    % nccreate(outputFile, sprintf('ENS3HQ%d', i), 'Dimensions', {'west_east', dims_write(1) , 'south_north', dims_write(2), 'bottom_top', dims_write(3),'Time', ntime(1) });
    t_write(:,:,:,1) = t_out( :, :, :,i);
    ncwrite(outputFile, sprintf('ENS3HQ%d', i), t_write ) ;
    i
end
